...
public class SoulFlamethrowerProjectile extends Projectile {

    public SoulFlamethrowerProjectile() {
    }

    public SoulFlamethrowerProjectile(Level level, float x, float y, float targetX, float targetY, int distance, GameDamage damage, Mob owner) {
        this.setLevel(level);
        this.x = x;
        this.y = y;
