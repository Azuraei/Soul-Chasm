...
public class SpinnerSpikeProjectile extends Projectile {
    private int tickCounter;

    public SpinnerSpikeProjectile() {
    }

    public SpinnerSpikeProjectile(Level level, float x, float y, float targetX, float targetY, int distance, GameDamage damage, int knockback, Mob owner) {
        this.setLevel(level);
        this.x = x;
        this.y = y;
