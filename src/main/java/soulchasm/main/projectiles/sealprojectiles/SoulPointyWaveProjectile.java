...
public class SoulPointyWaveProjectile extends Projectile {

    public SoulPointyWaveProjectile() {
    }

    public SoulPointyWaveProjectile(Level level, float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, Mob owner) {
        this.setLevel(level);
        this.x = x;
        this.y = y;
