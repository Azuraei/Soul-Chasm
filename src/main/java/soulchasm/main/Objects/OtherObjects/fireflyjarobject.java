...
public class fireflyjarobject extends GameObject {
    public static GameTexture texture;
    public ArrayList<InventoryItem> list;

    public fireflyjarobject() {
        this.mapColor = new Color(255, 251, 148, 249);
    ...
    public void loadTextures() {
        super.loadTextures();
        texture = GameTexture.fromFile("objects/fireflyjarobject");
    }
