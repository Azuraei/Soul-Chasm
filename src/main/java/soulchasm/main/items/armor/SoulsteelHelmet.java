...
public class SoulsteelHelmet extends SetHelmetArmorItem {
    public SoulsteelHelmet() {
        super(30, DamageTypeRegistry.MELEE, 1900, IncursionHeadArmorLootTable.incursionHeadArmor, IncursionArmorSetsLootTable.incursionArmorSets, Rarity.EPIC, "soularmorhelmet", "soularmorchestplate", "soularmorboots", "soularmorhelmetsetbonus");
    ...
    public ArmorModifiers getArmorModifiers(InventoryItem item, Mob mob) {
        return new ArmorModifiers(
                new ModifierValue(BuffModifiers.MELEE_CRIT_DAMAGE, 0.25F),
