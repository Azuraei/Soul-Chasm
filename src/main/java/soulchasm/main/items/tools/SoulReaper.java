...
public class SoulReaper extends GreatswordToolItem {
    public SoulReaper() {
        super(1950, IncursionCloseRangeWeaponsLootTable.incursionCloseRangeWeapons, SoulReaper.getScytheChargeLevels(300, 600, 900));
