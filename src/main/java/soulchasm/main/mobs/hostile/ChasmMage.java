...
public class ChasmMage extends HostileMob {
    ...
    public void init() {
        super.init();
        PlayerChaserWandererAI<ChasmMage> playerChaserAI = new PlayerChaserWandererAI<ChasmMage>(null, 540, 320, 40000, true, false) {
            public boolean attackTarget(ChasmMage mob, Mob target) {
