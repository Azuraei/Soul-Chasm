...
public class ChasmDragon extends BossWormMobHead<ChasmDragonBody, ChasmDragon> {
    ...
    public ChasmDragon() {
        ...
        this.roarAbility = this.registerAbility(new EmptyMobAbility() {
            protected void run() {
                if (ChasmDragon.this.getLevel().isClient()) {
        ...
        this.temporarySpeedAbility = this.registerAbility(new FloatMobAbility() {
            protected void run(float value) {
                ChasmDragon.this.temporarySpeed = value;
            }
        });
    }
    ...
    protected float getDistToBodyPart(ChasmDragonBody bodyPart, int index, float lastDistance) {
    ...
    protected ChasmDragonBody createNewBodyPart(int index) {
        ChasmDragonBody bodyPart = new ChasmDragonBody();
        int tailParts = 3;
        if (index == 1) {
            bodyPart.spriteY = 1;
    ...
    public static class SoulDragonAI<T extends ChasmDragon> extends SelectorAINode<T> {
        public SoulDragonAI() {
            ...
            chaserSequence.addChild(new ChasmDragon.IdleTime(4000, chaserAI));
            chaserSequence.addChild(new ChasmDragon.FragmentAttackRotation<>());
            chaserSequence.addChild(new ChasmDragon.EruptionAttackRotation<>(chaserAI,4));
            chaserSequence.addChild(new ChasmDragon.IdleTime(2000, chaserAI));
            chaserSequence.addChild(new ChasmDragon.EnragedState(3000, chaserAI));
            chaserSequence.addChild(new ChasmDragon.IdleTime(1000, chaserAI));
            chaserSequence.addChild(new ChasmDragon.FlamethrowerAttackRotation(chaserAI, 6000));
            chaserSequence.addChild(new ChasmDragon.IdleTime(1000, chaserAI));
            chaserSequence.addChild(new ChasmDragon.EruptionAttackRotation<>(chaserAI,6));
            chaserSequence.addChild(new ChasmDragon.FragmentAttackRotation<>());
            chaserSequence.addChild(new ChasmDragon.IdleTime(3000, chaserAI));
            chaserSequence.addChild(new ChasmDragon.EnragedState(4000, chaserAI));
            chaserSequence.addChild(new ChasmDragon.HomingAttackRotation());

            this.addChild(new WandererAINode(0));
        }
    }

    public static class EnragedState<T extends ChasmDragon> extends RunningAINode<T> {
        public int msToIdle;
        private int timer;
    ...
    public static class FlamethrowerAttackRotation<T extends ChasmDragon> extends RunningAINode<T> {
        private ChargingCirclingChaserAINode<T> chaserAI;
        public int msToIdle;
        private int timer;
        ...
        public void attack(T mob){
            ...
            for(int i = -1; i < 1; i++){
                SoulFlamethrowerProjectile projectile = new SoulFlamethrowerProjectile(mob.getLevel(), dragonHeadX, dragonHeadY, (float) targetX, (float) targetY, (int) (450 + mob.getCurrentSpeed()), ChasmDragon.soulDragonFlamethrowerDamage, mob);
    ...
    public static class HomingAttackRotation<T extends ChasmDragon> extends RunningAINode<T> {
        ...
        public AINodeResult tickRunning(T mob, Blackboard<T> blackboard) {
            ...
            float angle = 40;
            for(int i = -4; i<4; i++){
                SoulHomingProjectile projectile = new SoulHomingProjectile(mob.getLevel(), mob, mob.x, mob.y, (float) targetX, (float) targetY, 40, 600,  ChasmDragon.soulDragonHomingProjectileDamage, 20);
    ...
    public static class EruptionAttackRotation<T extends ChasmDragon> extends RunningAINode<T> {
    ...
    public static class FragmentAttackRotation<T extends ChasmDragon> extends RunningAINode<T> {
