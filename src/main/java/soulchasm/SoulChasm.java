...
public class SoulChasm {
    ...
    public void init() {
        ...
        ItemRegistry.registerItem("tobeblindfold", new HelmetArmorItem(0, (DamageType)null, 0, Item.Rarity.EPIC, "tobeblindfold").hairDrawMode(ArmorItem.HairDrawMode.UNDER_HAIR), 150.0F, true);
