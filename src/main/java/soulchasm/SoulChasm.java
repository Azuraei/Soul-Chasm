...
import soulchasm.main.buffs.trinketbuffs.dashersbuffs.PhantomDashersActiveBuff;
import soulchasm.main.buffs.trinketbuffs.dashersbuffs.PhantomDashersBuff;
...
public class SoulChasm {
    ...
    public void init() {
        ...
        ItemRegistry.registerItem("soulstatue", new SoulIdolSummon(), -1.0F, true);
        //Armor
